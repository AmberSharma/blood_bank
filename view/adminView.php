...
<script>
  ...
  {
  $.ajax({
  url: '../controller/adminController.php?method=fetchEmployee',
		...
		<div id="access" role="navigation">
           ...
           <div class="menu-header">
            <ul id="menu-main-menu" class="menu">
             ...
             <li id="menu-item-38" class="menu-item menu-item-type-custom menu-item-38"><a href="#">Create User</a></li>
             <li id="menu-item-42" class="menu-item menu-item-type-post_type menu-item-42"><a href="#" onclick="create_event()">Create Event</a></li>
                                    ...
                                    <div id="tab1">
                                        <p> Welcome Admin,</p>
                                          <p> Here are some of the features provided for you.</p>
                                           ...
                                           <p>You can create user here by clicking on to the <a href=""> Create User</a> link.
                                           You can also manage user and view edit and delete the users too.</p>
                                           
                                           <p>You can also upload your favourite images also by clicking on to the <a href="#">Upload Images</a> link.</p>
                                           
                                           <p>You can also create a event for your blood campaign by clicking on to the <a href=""> Create Event</a> link.</p>
                                    </div>
